...
def distance_list_generator(archetype_index, d_a, n_limit_starter):
    ...
    n_cr_list = list(range(0, n_max_cr))

    for n in n_cr_list:
        if n < n_limit_starter:
            # TODO check the most proper output
...
if __name__ == "__main__":
    ...
    for archetype in archetype_db:
        ...
        if i == 0:
            ...
            i += 1
            print_matrix_by_scope(archetype)
